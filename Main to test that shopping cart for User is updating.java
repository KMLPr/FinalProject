public class Main {
    public static void main(String[] args) {
        ...
        ShoppingCart updateCart = user.getShoppingCart();
        updateCart.removeProduct(product1.getName());
        System.out.println("All products in updated user shopping cart: ");
        System.out.println(updateCart.getProducts());
        System.out.println("Total price: " + updateCart.calculateTotalPrice());
        user.updateCart(userShopping);
    }
}